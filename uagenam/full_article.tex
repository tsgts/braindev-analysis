...
\hline
$h_1$ & $n_{11}$ & $n_{12}$ & $n_{13}$ & $\cdots$ & $k_{1C}$ & $N_{1.}$\\ 
$h_{2}$ & $n_{21}$ & $n_{22}$ & $n_{23}$ & $\cdots$ & $k_{2C}$ & $N_{2.}$\\ 
$h_{3}$ & $n_{31}$ & $n_{32}$ & $n_{33}$ & $\cdots$ & $k_{3C}$ & $N_{3.}$\\ 
$\vdots$ & $\vdots$ & $\vdots$ & $\vdots$ & $\ddots$ & $\vdots$ & $\vdots$\\ 
$h_{R}$ & $n_{R1}$ & $n_{R2}$ & $n_{R3}$ & $\cdots$ & $k_{RC}$ & $N_{R.}$\\ 
\hline
