...
Initial clustering with traditional methods.
...
\caption{A force-based layout of the correlation relationships between mouse genes computed using the ForceAtlas2 algorithm developed by \cite{Jacomy2014ForceAtlas2AC}. Distances between genes were computed from the same correlation matrix used in figure Figure~\ref{fig:correlations}. \label{fig:network}%
}
\end{center}
\end{figure}
