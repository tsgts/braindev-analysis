...
data = np.transpose(np.loadtxt('allen_data/dev_human/tsne/tsne_9000.txt')).tolist()
...
df.to_csv("allen_data/dev_human/human_encoded_corr_pearson_matrix.csv",sep=',', encoding='utf-8')